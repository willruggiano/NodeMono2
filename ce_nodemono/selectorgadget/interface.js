...
SelectorGadget.prototype.setupBorders = function() {
  if (!this.b_top) {
    ...
    this.b_top = jQuery('<div>').addClass('sg_border').css('height', width).hide().bind("mousedown.sg", {
      'self': this
    }, this.sgMousedown);
    this.b_bottom = jQuery('<div>').addClass('sg_border').addClass('sg_bottom_border').css('height', this.px(this.border_width + 6)).hide().bind("mousedown.sg", {
      'self': this
    }, this.sgMousedown);
    this.b_left = jQuery('<div>').addClass('sg_border').css('width', width).hide().bind("mousedown.sg", {
      'self': this
    }, this.sgMousedown);
    this.b_right = jQuery('<div>').addClass('sg_border').css('width', width).hide().bind("mousedown.sg", {
      'self': this
    }, this.sgMousedown);
...
SelectorGadget.prototype.setupEventHandlers = function() {
  // jQuery("*:not(.sg_ignore)").bind("mouseover.sg", {
  //   'self': this
  // }, this.sgMouseover);
  // jQuery("*:not(.sg_ignore)").bind("mouseout.sg", {
  //   'self': this
  // }, this.sgMouseout);
  jQuery("*:not(.sg_ignore)").bind("mousedown.sg", {
    'self': this
  }, this.sgMousedown);
  jQuery("html").bind("keydown.sg", {
    'self': this
  }, this.listenForActionKeys);
  jQuery("html").bind("keyup.sg", {
    'self': this
...
SelectorGadget.prototype.makeInterface = function() {
  ...
  this.clear_button = jQuery('<input type="button" value="Clear"/>').bind("click", {
    'self': this
  }, this.clearEverything).addClass('sg_ignore');
  ...
  this.sg_div.append(jQuery('<input type="button" value="XPath"/>').bind("click", {
    'self': this
  }, this.showXPath).addClass('sg_ignore'));

  this.sg_div.append(jQuery('<input type="button" value="Help"/>').bind("click", {
    'self': this
  }, this.showHelp).addClass('sg_ignore'));

  this.sg_div.append(jQuery('<input type="button" value="X"/>').bind("click", {
    'self': this
  }, this.unbind).addClass('sg_ignore'));
